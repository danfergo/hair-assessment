...
class VideoDataset(torch.utils.data.IterableDataset):
    def __init__(self, root, epoch_size=None, frame_transform=None, video_transform=None, step_frames=1, clip_len=16):
    ...
    def __iter__(self):
        ...
        for i in range(self.epoch_size):
            ...
            yield x.to('cuda'), y_true.to('cuda')
...
if __name__ == '__main__':
    base = '/home/danfergo/Projects/PhD/Unilever Project/code/data'
    transforms = [t.Resize((112, 112))]
    frame_transform = t.Compose(transforms)
    dataset = VideoDataset(base, epoch_size=None, frame_transform=frame_transform)
...
#
# #
# loader = DataLoader(dataset, batch_size=33)
